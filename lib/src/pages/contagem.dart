          ...
          builder: (BuildContext context, AsyncSnapshot<dynamic> snapshot) {
            if (snapshot.hasData) {
              ...
              for (var i = 0; i < tamanhoLista; i++) {
                ...
                '${_calculaTotal(
                    caixasExistentes[i].text, unidadesExistentes[i].text,
                    fatorCaixa)}';
                          ...
                          child: SingleChildScrollView(
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: constraints.minHeight,width: constraints.maxWidth,
                                  child: CustomScrollView(scrollDirection: Axis.horizontal,shrinkWrap: true,slivers: [
                                    SliverFillRemaining(
                                      hasScrollBody: false,
                                      child: DataTable(columns: [
                                        DataColumn(
